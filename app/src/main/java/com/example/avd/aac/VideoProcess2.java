...
public class VideoProcess2 {
    ...
    public static void appendVideo(String inputPath1, String inputPath2, String outputPath) {
        try {
            appendVideoImpl(inputPath1, inputPath2, outputPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    //视频拼接
    public static boolean appendVideoImpl(String inputPath1, String inputPath2, String outputPath) throws IOException {
