...
public class ClientLiveChatActivity extends AppCompatActivity implements SocketCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_live_chat);
        initView();
    }
    ...
    public void connect(View view) {
        localSurfaceView.startCapture(new ClientSocketLive(this));
    }
